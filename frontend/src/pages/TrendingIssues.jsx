      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-400">Real-time Analytics</span>
          </div>
          ...
          <p className="text-slate-500 font-bold max-w-xl text-xs uppercase tracking-widest leading-relaxed opacity-70">
        ...
        {trending.length === 0 ? (
          <motion.div 
            ...
            className="glass-card rounded-[3.5rem] p-32 text-center border-2 border-dashed border-white/5"
          >
            <AlertCircle className="w-20 h-20 text-slate-800 mx-auto mb-8" />
            <h3 className="text-xl font-black text-white uppercase tracking-widest mb-4">No Active Clusters</h3>
            <p className="text-slate-500 font-black uppercase text-[10px] tracking-widest">Scanning city matrix for recurring incident patterns...</p>
          </motion.div>
        ) : (
          <div className="space-y-8">
            <div className="glass-panel rounded-[3.5rem] overflow-hidden border-white/5 shadow-3xl bg-white/5">
              <div className="overflow-x-auto custom-scrollbar">
                <table className="w-full">
                  <thead>
                    <tr className="bg-white/5 border-b border-white/5">
                      <th className="px-10 py-8 text-left text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Rank</th>
                      <th className="px-10 py-8 text-left text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Issue Intelligence</th>
                      <th className="px-10 py-8 text-left text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Geospatial Vector</th>
                      <th className="px-10 py-8 text-left text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Intensity</th>
                      <th className="px-10 py-8 text-left text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">Matrix ID</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-white/5">
                    {trending.map((cluster, index) => (
                      <motion.tr 
                        ...
                        className="hover:bg-white/5 transition-all duration-500 group"
                      >
                        ...
                        <td className="px-10 py-8">
                          <div className="flex items-center gap-4">
                            ...
                            <span className="font-black text-white uppercase text-xs tracking-tighter">
                              {cluster.issue_type}
                            </span>
                          </div>
                        </td>
                        ...
                        <td className="px-10 py-8">
                          <div className="flex items-center gap-3">
                            <div className="flex-1 h-2 bg-white/5 rounded-full w-24 overflow-hidden border border-white/5">
                               <motion.div 
                                 initial={{ width: 0 }}
                        ...
                        <td className="px-10 py-8">
                          <span className="text-[8px] font-black text-slate-500 uppercase tracking-widest bg-white/5 px-3 py-1.5 rounded-lg border border-white/5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={i} className="glass-card rounded-[2.5rem] p-10 border border-white/5 shadow-2xl relative overflow-hidden group">
                  ...
                  <p className="text-4xl font-black text-white tracking-tighter uppercase leading-none">{item.value}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="mt-24">
          ...
          <div className="glass-card rounded-[3.5rem] p-2 overflow-hidden border-white/5 shadow-3xl">
             <CityNews news={news} />
          </div>
        </div>
      </div>
