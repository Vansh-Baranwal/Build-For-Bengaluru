      ...
      >
        ...
        >
          ...
          <div className="mb-10">
            ...
            <h2 className="text-4xl font-black text-slate-900 tracking-tighter leading-none mb-4 uppercase">How was the resolution?</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            ...
            <div className="space-y-4">
              ...
              <textarea
                ...
                className="w-full bg-slate-50 border-2 border-transparent focus:border-indigo-100 rounded-[2rem] px-8 py-6 text-sm font-medium outline-none transition-all placeholder:text-slate-400 min-h-[140px]"
              />
            </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-indigo-600">Citizen Intelligence Matrix</span>
            </div>
            ...
            <p className="text-slate-500 font-medium max-w-md uppercase text-xs tracking-tighter leading-relaxed">Monitoring and enhancing Bengaluru's infrastructure through collective intelligence.</p>
          </div>
          ...
          >
            <div className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center group-hover:rotate-90 transition-transform duration-700">
          ...
          {[
            ...
            >
              <div className="flex justify-between items-start mb-8">
                <div className={`p-5 rounded-2xl bg-${stat.color}-50 text-${stat.color}-600`}>
                  <stat.icon className="w-8 h-8" />
                </div>
                {stat.color === 'amber' && <Sparkles className="w-4 h-4 text-amber-500 animate-pulse" />}
              </div>
        ...
        <div className="flex flex-col lg:flex-row gap-16">
          <div className="flex-1">
            <div className="flex items-center justify-between mb-10">
              <div className="flex items-center gap-4">
                ...
                <h2 className="text-3xl font-black text-slate-900 tracking-tight uppercase">Intelligence Ledger</h2>
              </div>
            </div>
                ...
                >
                  {complaints.map((complaint) => (
                    <motion.div
                      ...
                      variants={itemVariants}
                      className="group glass-card rounded-[3rem] p-10 transition-all duration-700 hover:shadow-2xl hover:shadow-indigo-100/30 relative overflow-hidden"
                    >
                      <div className="flex flex-col md:flex-row gap-10 relative z-10">
                        <div className="w-full md:w-64 h-48 rounded-[2.5rem] overflow-hidden shadow-2xl">
                          <img 
                        ...
                        <div className="flex-1">
                          <div className="flex flex-wrap items-center gap-3 mb-6">
                            <span className="text-[10px] font-black uppercase tracking-widest bg-slate-900 text-white px-4 py-1.5 rounded-full">ID: {complaint.complaint_id.slice(0, 8)}</span>
                          ...
                          <h3 className="text-2xl font-black text-slate-900 mb-2 uppercase tracking-tight">{complaint.category}</h3>
                          <p className="text-slate-500 font-medium text-sm leading-relaxed mb-8 uppercase tracking-tighter line-clamp-2">{complaint.description}</p>
                              ...
                              <div className="flex justify-end">
                                {complaint.feedback_rating ? (
                                  <div className="flex items-center gap-2 bg-amber-50 px-4 py-1.5 rounded-full">
                                    ...
                                    <span className="text-[10px] font-black text-amber-700 uppercase">{complaint.feedback_rating}/5</span>
                                  </div>
                                ) : (
                                  <button
                                    onClick={() => { setSelectedComplaint(complaint); setShowFeedbackModal(true); }}
                                    className="flex items-center gap-2 text-indigo-600 text-[10px] font-black uppercase tracking-widest hover:underline px-2"
                                  >
          ...
          <motion.div className="hidden lg:block lg:w-96 space-y-10">
            <div className="glass-card rounded-[3.5rem] p-12 text-center group">
              <div className="w-28 h-28 bg-slate-900 rounded-[2.5rem] flex items-center justify-center mx-auto mb-8 shadow-2xl rotate-3 group-hover:rotate-0 transition-transform duration-500">
                <Star className="w-14 h-14 text-indigo-400 fill-indigo-400 animate-pulse-soft" />
              </div>
              <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">Engagement Analytics</p>
              <h4 className="text-4xl font-black text-slate-900 mb-8 uppercase tracking-tighter">Elite Rank</h4>
              <div className="w-full bg-slate-100 h-2.5 rounded-full overflow-hidden mb-4">
                <motion.div initial={{ width: 0 }} animate={{ width: '85%' }} className="bg-slate-900 h-full"></motion.div>
              </div>
              <p className="text-[10px] font-black text-indigo-600 uppercase tracking-[0.2em] text-right">Top 5% Contributor</p>
            </div>
            ...
            <div className="bg-slate-900 rounded-[3.5rem] p-12 text-white relative overflow-hidden">
               <div className="relative z-10">
                  ...
                  <p className="text-2xl font-black mb-10 leading-[1.1] uppercase italic tracking-tighter">Validate infrastructure breach at <span className="text-indigo-400">Whitefield Sector 5</span></p>
                  <button className="w-full bg-white text-slate-900 py-6 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] hover:bg-indigo-400 hover:text-white transition-all shadow-2xl">
                    Accept Protocol
                  </button>
               </div>
            </div>
